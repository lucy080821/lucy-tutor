...
- **LESSONS** — Bài học từ lớp đã tham gia
...
Tabs chính:
- **OVERVIEW** — Thống kê lớp, biểu đồ điểm trung bình (BarChart)
- **CLASSROOMS** — Quản lý lớp học (tạo/sửa/xóa), xem danh sách học sinh
- **EXAMS** — Tạo đề thi, giao đề, import từ Word/PDF
- **QUESTIONS** — Ngân hàng câu hỏi
- **LESSONS** — Tạo bài học (editor ReactQuill)
- **DOCUMENTS** — Tài liệu đính kèm
- **ATTENDANCE** — Điểm danh học sinh
- **TUITION** — Học phí (xuất hóa đơn PDF/Excel)
